...
- **Format Requirements** — Preferred file format, schema expectations, and any change needs
...
- **Audit Trail** — Maintain a log of what data was requested, when it was received, who accessed it, and any changes applied. This trail supports reproducibility and demonstrates compliance if the engagement is ever reviewed.
