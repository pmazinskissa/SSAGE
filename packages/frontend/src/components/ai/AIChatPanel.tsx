      ...
      <AnimatePresence>
        {chatOpen && (
          <motion.div
            ...
            className="fixed bottom-6 right-6 z-40 w-[640px] max-w-[calc(100vw-2rem)] h-[680px] max-h-[calc(100vh-6rem)] bg-white border border-border rounded-2xl shadow-xl flex flex-col overflow-hidden"
          >
            {/* Header */}
