      ...
      <div className="my-8">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'auto auto', gap: '1.25rem', alignItems: 'stretch', justifyContent: 'center' }}>
          <div style={{ gridColumn: '1 / -1', textAlign: 'center', marginBottom: '0.25rem' }}>
            <span style={{ fontWeight: 800, fontSize: '1.1rem', color: '#4F46E5', letterSpacing: '0.04em', textTransform: 'uppercase' }}>
              Phase 1: Diagnosis
            </span>
          </div>
          <div>
            ...
            {phases.map((p, i) => {
              ...
              return (
                <g key={i}>
                  ...
                  <text x={numX} y={numY + 1} textAnchor="middle" dominantBaseline="middle" fill="white" fontSize="8" fontWeight="700">
                    {p.short}
                  </text>
                </g>
              );
