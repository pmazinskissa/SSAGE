...
const Arrow = ({ dir }: ArrowProps) => {
  const style = { display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 as const };
  return (
    <div style={style}>
      {dir === 'e' && <svg width="36" height="20"><line x1="2" y1="10" x2="30" y2="10" stroke="#4F46E5" strokeWidth="2.5" /><polygon points="30,5 36,10 30,15" fill="#4F46E5" /></svg>}
      {dir === 's' && <svg width="20" height="36"><line x1="10" y1="2" x2="10" y2="30" stroke="#4F46E5" strokeWidth="2.5" /><polygon points="5,30 10,36 15,30" fill="#4F46E5" /></svg>}
      {dir === 'w' && <svg width="36" height="20"><line x1="6" y1="10" x2="34" y2="10" stroke="#4F46E5" strokeWidth="2.5" /><polygon points="6,5 0,10 6,15" fill="#4F46E5" /></svg>}
      {dir === 'n' && <svg width="20" height="36"><line x1="10" y1="6" x2="10" y2="34" stroke="#4F46E5" strokeWidth="2.5" /><polygon points="5,6 10,0 15,6" fill="#4F46E5" /></svg>}
    </div>
  );
};
