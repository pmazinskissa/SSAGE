...
export default function MultiTurnPromptFCR() {
  return (
    <ScrollReveal>
      <div className="my-8">
        <h3 style={{fontWeight:700, fontSize:'1.1rem', color:'#1E1B4B', marginBottom:'0.25rem'}}>
          Multi-Turn Prompt: FCR Analysis with Visualization
        </h3>
        <p style={{fontSize:'0.85rem', color:'#6B7280', marginBottom:'1rem'}}>
          Multi-turn conversation showing FCR benchmarks and visualization suggestions
        </p>
        ...
        <div style={{background:'#F3F4F6',borderRadius:12,padding:'1rem',maxWidth:560,margin:'0 auto'}}>
          ...
          <AIBubble>
            <div style={{fontWeight:700,color:'#4F46E5',marginBottom:'0.4rem',fontSize:'0.83rem'}}>FCR Benchmarks &mdash; Telecom</div>
            <div style={{fontSize:'0.8rem',color:'#374151',lineHeight:1.6}}>
              <strong>Industry average:</strong> 71&ndash;76% &nbsp;|&nbsp; <strong>Top quartile:</strong> &gt;85%<br/>
          ...
          <AIBubble>
            ...
            <div style={{fontSize:'0.8rem',color:'#374151',lineHeight:1.6}}>
              A <strong>choropleth heat map</strong> overlaid on service zones would work best &mdash; darker colors indicate lower FCR. Pair it with a <strong>ranked bar chart</strong> sorted by FCR rate to show the gap between regions and the 85% top-quartile benchmark line.<br/><br/>
