  ...
  const charts = [
    {
      ...
      when: 'Ranked items, side-by-side comparison',
      svg: (
    ...
    },
    {
      ...
      when: 'Time series, continuous change',
      svg: (
        <svg viewBox="0 0 60 40" width="60" height="40">
    ...
    {
      name: 'Scatter Plot',
      use: 'Correlate two variables',
      when: 'Two variables, quadrant placement',
      svg: (
        <svg viewBox="0 0 60 40" width="60" height="40">
    ...
    {
      name: 'Heat Map',
      use: 'Show density/intensity',
      when: 'Matrix data, geographic density',
      svg: (
        <svg viewBox="0 0 60 40" width="60" height="40">
          {(
            [
    ...
    {
      name: 'Treemap',
      use: 'Show hierarchical proportions',
      when: 'Part-of-whole, nested categories',
      svg: (
        <svg viewBox="0 0 60 40" width="60" height="40">
    ...
    {
      name: 'Combo Chart',
      use: 'Overlay multiple data types',
      when: 'Multiple types, trend + category',
      svg: (
        <svg viewBox="0 0 60 40" width="60" height="40">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '0.6rem' }}>
          {charts.map((c, i) => (
            ...
            >
              ...
              <div style={{ fontSize: '0.7rem', color: '#9CA3AF', marginTop: '0.1rem', fontStyle: 'italic' }}>
                {c.when}
              </div>
            </div>
          ))}
